...
\textcolor{color-jury}{
\begin{tabular}{@{}lll}
\hspace{2.54cm} & Someone & Very high position, Somewhere \\
                & Someone else & Another high position, Somewhere else\\
\end{tabular}}
...
\textcolor{color-jury}{
\begin{tabular}{@{}lll}
Pr\'{e}sident :        & Jacques Chirac & French president, France \\
Examinateurs :         & Yoda & Master, Dagobha\\
Dir. de th\`{e}se :    & Fr\'{e}d\'{e}ric Yermia & Professeur, Université de Nantes \\
Co-dir. de th\`{e}se : & Benoit Viaud & Professeur, CNRS \\
\end{tabular}}
