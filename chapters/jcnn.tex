...
In this study we use one million events coming from monte-carlo simulations. To put in perspective, the expected IBD rate in JUNO is 47 / days. Taking into account the calibration time, and the source reactor shutdown, it amount to $\sim 94'000$ IBD events in 6 years. With this million of event, we are training on $\sim 10$ years of data.
